<template>
  <ion-page>
    <!-- top bar component -->
    <top-bar title="Snap"></top-bar>
    <ion-content :fullscreen="true">
      <ion-list>
        <ion-item v-for="snap of snaps" :key="snap.id" :router-link="`/snaps/${snap.id}`">
          <ion-thumbnail slot="end">
            <ion-img :src="snap.imgUrl" :alt="snap.title"></ion-img>
          </ion-thumbnail>
          {{ snap.title }}
        </ion-item>
      </ion-list>
...
<script lang="ts">
import { IonPage, IonContent, IonList, IonItem, IonImg, IonThumbnail } from '@ionic/vue';

import { defineComponent } from 'vue';
import { Snaps } from '../models/snaps';
